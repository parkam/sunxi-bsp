...
help:
	...
	@echo ""
	@echo "Custom targets:"
	@echo "  filedisk             - compile everything (hwpack) and create a filedisk image in "  
	@echo "                         $(FILEDISK_IMG)"
	@echo "    Arguments:"
	@echo "      ROOTFS=          - Source rootfs (ie. rootfs.tar.gz)"
	@echo "  optimize             - apply several optimization steps. See build.sh::optimize."  
	@echo "  changeroot           - chroot into the create filedisk image."  
	@echo "  removeloops          - unmount and delete the loop devices used for the filedisk."
	@echo "  write2sd             - write image to sd card."
	@echo "   Arguments:"
	@echo "    SD_CARD=           - Target  (ie. /dev/sdx)"
	@echo ""
